...
using ArticleDetail = Chronicis.Client.ViewModels.ArticleDetail;
...
public static class ApplicationServiceExtensions
{
    ...
    public static IServiceCollection AddChronicisApplicationServices(this IServiceCollection services)
    {
        ...
        // Facade services (simplify component dependencies)
        services.AddScoped<IAISummaryFacade, AISummaryFacade>();
        services.AddScoped<IWorldCampaignFacade, WorldCampaignFacade>();
        services.AddScoped<IArticleDetailFacade, ArticleDetailFacade>();
        
        // ViewModels
        services.AddScoped<ArticleDetail.IArticleDetailViewModel, ArticleDetail.ArticleDetailViewModel>();
